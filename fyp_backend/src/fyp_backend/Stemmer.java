...
public class Stemmer implements Function<Word,Word> {
  ...
  */
   ...
   */
  public String main_stem(String input) throws IOException, SuggesterException {
    Stemmer s = new Stemmer();
    Corrector obj_cor=new Corrector();
    String output =s.stem(input);
    //if (output.equalsIgnoreCase(obj_cor.main_corrector(input)))
  //  {
